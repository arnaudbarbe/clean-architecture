...
import fr.arnaud.cleanarchitecture.infrastructure.configuration.eventdriven.publisher.TeamEventPublisher;
...
public class TeamAspect {
    ...
    @After("execution(* fr.arnaud.cleanarchitecture.core.service.team.DomainTeamService.updateTeam(..)) && args(team)")
    public void eventAfterUpdateTeam(final JoinPoint joinPoint, final Team team) {
