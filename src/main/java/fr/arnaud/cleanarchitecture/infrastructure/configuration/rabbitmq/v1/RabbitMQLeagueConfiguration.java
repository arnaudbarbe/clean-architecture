...
public class RabbitMQLeagueConfiguration {
	...
	private static final String CREATE_LEAGUE_QUEUE_NAME_REQUEST = "createLeagueV1Request";
    
	private static final String UPDATE_LEAGUE_QUEUE_NAME_REQUEST = "updateLeagueV1Request";

	private static final String DELETE_LEAGUE_QUEUE_NAME_REQUEST = "deleteLeagueV1Request";

	private static final String CREATE_LEAGUE_EXCHANGE_NAME_REQUEST = "createLeagueV1Request";
	
	private static final String UPDATE_LEAGUE_EXCHANGE_NAME_REQUEST = "updateLeagueV1Request";
    
	private static final String DELETE_LEAGUE_EXCHANGE_NAME_REQUEST = "deleteLeagueV1Request";
    ...
    // publisher    
    @Bean
    public MessageChannel createLeagueV1AsyncOutboundChannel() {
        return new DirectChannel();
    }

    @Bean
    @ServiceActivator(inputChannel = "createLeagueV1AsyncOutboundChannel")
    ...
    public MessageChannel updateLeagueV1AsyncOutboundChannel() {
        return new DirectChannel();
    }

    @Bean
    @ServiceActivator(inputChannel = "updateLeagueV1AsyncOutboundChannel")
    ...
    @Bean
    public MessageChannel deleteLeagueV1AsyncOutboundChannel() {
        return new DirectChannel();
    }


    @Bean
    @ServiceActivator(inputChannel = "deleteLeagueV1AsyncOutboundChannel")
