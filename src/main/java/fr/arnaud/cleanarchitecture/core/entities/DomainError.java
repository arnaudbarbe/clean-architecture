...
public class DomainError {
	public enum ErrorCodes {
		BAD_REQUEST, UNAUTHORIZED, FORBIDDEN, MISSING_PARAMETER, APPLICATION_FAILURE, BAD_CURRENT_PASSWORD, OBJECT_ALREADY_EXIST, NOT_FOUND, METHOD_NOT_ALLOWED, TOO_MANY_REQUESTS;
